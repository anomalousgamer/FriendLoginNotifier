...
Friend Login Notifier is a custom Dalamud plugin for Final Fantasy XIV that prints a bright-green chat notification when a character on your in-game Friends List changes from offline to online or moves from your current world to another world. When available, the notification includes the friend's current world.
...
* Prints a bright-green chat message when a friend changes from offline to online or moves from your current world to another world.
* Includes the friend's current world in login notifications whenever FFXIV provides it.
* Supports different-Home-World friends and same-Home-World friends who may be visiting another world.
...
This mode performs the same general Friend List refresh and then individually checks different-Home-World friends as well as eligible same-Home-World friends who may be visiting another world.
...
* **Sync All Friends** requests a general Friend List refresh and then individually checks friends who are on or may be on other worlds.
* **Sync Friends on Same World** requests only the general Friend List refresh and does not send individual cross-world checks.
* **Sync Friends on Other Worlds** individually checks different-Home-World friends and eligible same-Home-World friends who may be visiting elsewhere.
...
| `/friends sync`      | Refreshes the general Friend List and then checks friends who are on or may be on other worlds. |
| `/friends syncworld` | Refreshes the general Friend List without individual cross-world checks.                        |
| `/friends syncother` | Checks friends who are on or may be on other worlds.                                            |
...
* Manually sync friends who are on or may be on other worlds.
